const PrivacyPolicyPage = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Echados Pa'Lante.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Echados Pa'Lante, accessible from{' '}
            <a
              href="echadospalante.com"
      ...
      <ul>
        <li>By email: juan.cardona69@udea.edu.co</li>
      </ul>
    </>
  );
}